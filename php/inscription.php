...
if (!empty($_POST)) {
    ...
    { //==> fonction qui retourne un boolean | pour vérifier saisie utilisateur
...
?>" required>
			...
			<p>
				<label for="mdp"> </label></br>
				<input class="password" type="password" name="mdpbis" id="mdpbis" placeholder="Verification de votre mot de passe" value="<?php if (isset($_POST['mdpbis'])) {
    echo $_POST['mdpbis'];
}
?>" required>
			</p>
